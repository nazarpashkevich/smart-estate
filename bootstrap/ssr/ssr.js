...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(`./pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./pages/Auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword-ChI5ExnZ.js"), "./pages/Auth/ForgotPassword.vue": () => import("./assets/ForgotPassword-DVtWSyvy.js"), "./pages/Auth/Login.vue": () => import("./assets/Login-Csh5kCJr.js"), "./pages/Auth/Register.vue": () => import("./assets/Register-CHclzZaG.js"), "./pages/Auth/ResetPassword.vue": () => import("./assets/ResetPassword-BPwGF2l3.js"), "./pages/Auth/VerifyEmail.vue": () => import("./assets/VerifyEmail-BeTga3zy.js"), "./pages/Dashboard.vue": () => import("./assets/Dashboard-WofIalmj.js"), "./pages/Home.vue": () => import("./assets/Home-B0cMDNr4.js"), "./pages/Profile/Edit.vue": () => import("./assets/Edit-yZAHqj4Y.js"), "./pages/Profile/Partials/DeleteUserForm.vue": () => import("./assets/DeleteUserForm-BGdVH0wr.js"), "./pages/Profile/Partials/UpdatePasswordForm.vue": () => import("./assets/UpdatePasswordForm-DKM9RCQ5.js"), "./pages/Profile/Partials/UpdateProfileInformationForm.vue": () => import("./assets/UpdateProfileInformationForm-ClWkgY7l.js"), "./pages/Search/Index.vue": () => import("./assets/Index-DWCYvnrC.js") })),
